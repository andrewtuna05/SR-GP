...
The motivation for this passion project was to self-explore applications of Gaussian Processes and to develop a simple framework for examples of image reconstruction. 
